About happybase-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/happybase-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/wbolster/happybase
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3001&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/happybase-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `happybase` can be installed with `conda`:
...
```
mamba install happybase
```

It is possible to list all of the versions of `happybase` available on your platform with `conda`:
...
```
mamba search happybase --channel conda-forge
```
...
mamba repoquery search happybase --channel conda-forge

# List packages depending on `happybase`:
mamba repoquery whoneeds happybase --channel conda-forge

# List dependencies of `happybase`:
mamba repoquery depends happybase --channel conda-forge
```
